...
import com.cst.xinhe.persistence.model.terminal.StaffTerminalExample;
...
public interface StaffTerminalMapper {
    ...
    Map<String, Object> selectStaffNameByTerminalId(Integer terminalId);
    ...
    //批量插入终端信息
    int insertStaffTerminals(@Param("list") List<StaffTerminal> staffTerminals);

    Map<String, Object> selectTerminalAndPersonInfoByMac(String mac);
}
