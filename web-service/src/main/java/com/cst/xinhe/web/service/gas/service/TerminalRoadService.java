...
public interface TerminalRoadService {
    ...
    List<Map<String,Object>> findTerminalRoadByTime(int staffId,  Integer pageSize, Integer startPage,String startTime,String endTime,Integer isOre) throws ParseException;
